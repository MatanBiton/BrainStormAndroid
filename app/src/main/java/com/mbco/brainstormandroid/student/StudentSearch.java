...
public class StudentSearch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_student_search, container, false);
    ...
    public class LoadTeachers extends Thread{
        @Override
        public void run() {
            super.run();
            try {
                Requests.GetUsersByFilter(filter, filterValue, "teacher", new RequestsResultListener<ArrayList<User>>() {
                    @Override
